...
map('n', 'gn', '<cmd>lua require("zone.ui").rename()<cr>')
...
map('n', '<leader>ga', '<cmd>lua require("zone.ui").code_actions()<cr>')
map('v', '<leader>ga', '<cmd>lua require("zone.ui").range_code_actions()<cr>')
