...
function M.init(client, bufnr)
  local buf_map = require('zone.utils').buf_map
  ...
  buf_map(bufnr, 'n', 'gn', '<cmd>lua require("zone.ui").rename()<cr>')
  ...
  -- code actions
  buf_map(bufnr, 'n', '<leader>ga', '<cmd>lua require("zone.ui").code_actions()<cr>')
  buf_map(bufnr, 'v', '<leader>ga', '<cmd>lua require("zone.ui").range_code_actions()<cr>')
