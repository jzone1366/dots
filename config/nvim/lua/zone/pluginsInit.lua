...
return packer.startup(function()
  ...
  use({
    ...
    config = function()
      local icons = require('zone.core.theme.icons')
  ...
  use({
    ...
    config = function()
      require('zone.core.file-explorer')
    end,
    opt = true,
    cmd = {
      'NvimTreeClipboard',
