-- Override Zone configuration options
...
-- see Zone defaults: core/session/init.lua
config.session = {}
...
-- see Zone defaults: core/treesitter/init.lua
config.treesitter = {}
...
config.lsp = {
  ...
  -- see Zone defaults: lsp/diagnostics.lua
  diagnostic = {},
