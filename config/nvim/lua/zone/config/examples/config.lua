...
local config = {
  ...
  lsp = {
    ...
    servers = {
      ...
      -- See Zone defaults lsp/providers/null_ls.lua
      null_ls = {},
    },

    -- See Zone defaults lsp/providers/tsserver.lua
  ...
  -- theming, don't forget to run :ZoneReloadSync when changing themes
  -- 'catppuccin'
  -- 'dracula'
  -- 'enfocado'
  -- 'gruvbox'
  ...
  -- 'onedark'
  -- 'rose-pine'
  theme = 'tokyonight', -- don't define or set to nil, if you want to enable your own theme in zone/config/plugins.lua
