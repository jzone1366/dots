...
-- These use mini.basic window keybinds. So those are turned off.
-- Need to just use <C-w> for window movement.
-- Treewalker mappings
nmap('<C-k>', '<Cmd>Treewalker Up<CR>', 'Treewalker Up')
nmap('<C-j>', '<Cmd>Treewalker Down<CR>', 'Treewalker Down')
nmap('<C-h>', '<Cmd>Treewalker Left<CR>', 'Treewalker Left')
nmap('<C-l>', '<Cmd>Treewalker Right<CR>', 'Treewalker Right')

-- Treewalker mappings
nmap('<C-S-k>', '<Cmd>Treewalker SwapUp<CR>', 'Treewalker Swap Up')
nmap('<C-S-j>', '<Cmd>Treewalker SwapDown<CR>', 'Treewalker Swap Down')
nmap('<C-S-h>', '<Cmd>Treewalker SwapLeft<CR>', 'Treewalker Swap Left')
nmap('<C-S-l>', '<Cmd>Treewalker SwapRight<CR>', 'Treewalker Swap Right')
...
-- AI related mappings ====================================================
-- CopilotChat (lowercase)
nmap_leader('ac', '<Cmd>CopilotChatToggle<CR>',   'Copilot Chat')
nmap_leader('ae', '<Cmd>CopilotChatExplain<CR>',  'Copilot Explain')
nmap_leader('af', '<Cmd>CopilotChatFix<CR>',      'Copilot Fix')
...
nmap_leader('/u', '<Cmd>DepsUpdate<CR>', 'Update Dependencies')
nmap_leader('/i', '<Cmd>DepsShowLog<CR>', 'Show Deps Log')
