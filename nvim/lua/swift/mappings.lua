...
for _, mode in ipairs({ 'n', 'x', 'i', 'v', 'o', 't', 's', 'c' }) do
  ...
  -- swift[mode .. "map"] = mapper(mode, map_opts)
...
-- map({ "n", "x", "o" }, "n", "nzz<esc><cmd>lua swift.blink_cursorline(50)<cr>")
-- map({ "n", "x", "o" }, "N", "Nzz<esc><cmd>lua swift.blink_cursorline(50)<cr>")
-- map({ "n", "x", "o" }, "n", "nzz")
-- map({ "n", "x", "o" }, "N", "Nzz")

map({ 'n', 'x', 'o' }, 'n', 'nzzzv<esc><cmd>lua swift.blink_cursorline(150)<cr>', { desc = "Fwd  search '/' or '?'" })
map({ 'n', 'x', 'o' }, 'N', 'Nzzzv<esc><cmd>lua swift.blink_cursorline(150)<cr>', { desc = "Back search '/' or '?'" })

nnoremap('<C-f>', '<C-f>zz<Esc><Cmd>lua swift.blink_cursorline(75)<CR>')
nnoremap('<C-b>', '<C-b>zz<Esc><Cmd>lua swift.blink_cursorline(75)<CR>')

nnoremap('<C-d>', '<C-d>zz<Esc><Cmd>lua swift.blink_cursorline(75)<CR>')
nnoremap('<C-u>', '<C-u>zz<Esc><Cmd>lua swift.blink_cursorline(75)<CR>')
...
local editFileMappings = {
  r = {
    function()
      require('swift.utils').lsp.rename_file()
    end,
