...
return {
  ...
  },
  {
    ...
    cond = SwiftVim.plugins.zen.enabled,
  },
  {
    'folke/twilight.nvim',
    config = true,
  ...
  },
  {
    ...
    event = 'VeryLazy',
    config = function()
      vim.g.rooter_patterns = SwiftVim.plugins.rooter.patterns
  ...
  {
    'folke/noice.nvim',
    cond = SwiftVim.plugins.experimental_noice.enabled,
    lazy = false,
    config = function()
  ...
  },
  {
    ...
    cond = SwiftVim.plugins.jump_by_subwords.enabled,
    lazy = true,
    keys = { 'w', 'e', 'b', 'ge' },
    config = function()
  ...
  -- AI
  {
    ...
    cond = SwiftVim.plugins.ai.codeium.enabled,
    event = 'InsertEnter',
    cmd = 'Codeium',
    dependencies = {
      'nvim-lua/plenary.nvim',
