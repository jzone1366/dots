...
function M.git_branch()
  return b.gitsigns_head or '', icons.branch
end
...
function M.git_diff_added()
  return git_diff 'added', icons.diff_add
end

function M.git_diff_removed()
  return git_diff 'removed', icons.diff_remove
end

function M.git_diff_changed()
  return git_diff 'changed', icons.diff_modified
end
