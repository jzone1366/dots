return {
    {
        ...
        config = function()
            ...
            map('n', '<Leader>dc', "<CMD>lua require('dap').continue()<CR>",
                { noremap = true, silent = true, desc = 'DAP Contine' })
            ...
            map('n', '<Leader>dU', "<CMD>lua require('dapui').open()<CR>",
            ...
            map('n', '<Leader>dw', "<CMD>lua require('dapui').float_element('watches', { enter = true })<CR>",
                { noremap = true, silent = true, desc = 'DAP Watches' })
            map('n', '<Leader>ds', "<CMD>lua require('dapui').float_element('scopes', { enter = true })<CR>",
                { noremap = true, silent = true, desc = 'DAP Scopes' })
            map('n', '<Leader>dr', "<CMD>lua require('dapui').float_element('repl', { enter = true })<CR>",
