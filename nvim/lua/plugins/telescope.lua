return {
  {
    ...
    config = function()
      ...
      map("n", "<leader>ghh", telescope.extensions.advanced_git_search.search_log_content, { silent = true, desc = "Telescope advanced git search log content" })
      -- list of git commits that changed the current file. Grep commit content
      map("n", "<leader>ghf", telescope.extensions.advanced_git_search.search_log_content_file, { silent = true, desc = "Telescope advanced git search log content file" })
      -- list of git commits that changed the current file. Grep commit message
      map("n", "<leader>ghc", telescope.extensions.advanced_git_search.diff_commit_file, { silent = true, desc = "Telescope advanced git search diff commit file" })
    end,
  },
