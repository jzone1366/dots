...
function swift.blink_cursorline(delay, should_center)
  if is_ignored() then
    return
  end
...
--   )
--
--   if should_blink then swift.blink_cursorline() end
--
-- end

require('swift.autocmds').augroup('ToggleCursorLine', {
  {
